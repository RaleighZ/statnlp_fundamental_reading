...
![](./figs/count_based1.png){width="500px" height="200px" align="center"}
	...
	- More formally, denote by $V_{W}$ the set of words (vocab size) and by $V_{C}$ the set of possible contexts. The matrix ![](https://latex.codecogs.com/gif.latex?M^{f}&space;\in&space;R^{|V_{W}|&space;\times&space;|V_{C}|}) is the word-context matrix, defined as $M_{[i, j]}^{f} = f(w_{i}, c_{j})$, where $f$ is an association measure of the strength between a word and a context.
